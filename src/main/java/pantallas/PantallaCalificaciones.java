...
public class PantallaCalificaciones extends JFrame {
    ...
    private JPanel crearPanelIzquierdoTabla() {
        ...
        // Configurar Tabla
        String[] columnas = {"Alumno", "Curso", "Calificacion"};
    ...
    private JPanel crearPanelDerechoInscripcion() {
        ...
        btnGuardar.addActionListener(e -> {
            FachadaUtil.dialogoConfirmacion(PantallaCalificaciones.this, "¿Agregar este curso?", () -> guardarEstudiante());
        });
    ...
    private void guardarEstudiante() {
        ...
        try {
            ...
            FachadaUtil.dialogoAviso(PantallaCalificaciones.this, "Estudiante agregado");
        } catch (ControlException e) {
            FachadaUtil.dialogoError(PantallaCalificaciones.this, e.getMessage());
        }
